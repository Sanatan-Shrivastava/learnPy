# Write a code to print the table of 2:
# Write a code to find the sum of first 5 integers:
# write a code to take input of subjects of student and find the average percentage
